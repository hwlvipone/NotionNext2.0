...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '云端奇趣', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享各种网盘资源,考公资源,三支一扶,申论真题,影视资源,AI工具,收集各种有趣实用的软件和APP的下载,安装,使用方法,发现一些稀奇古怪的的网站,折腾一些有趣实用的教程,分享小快乐', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yunduanqiqu.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '云盘资源,免费课程,视频课程,BT种子,磁力链接,高清电影电视剧，考公资源,三支一扶,申论真题,影视资源,AI工具', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '云端奇趣', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '分享各种网盘资源,考公资源,三支一扶,申论真题,影视资源,AI工具,收集各种有趣实用的软件和APP的下载,安装,使用方法,发现一些稀奇古怪的的网站,折腾一些有趣实用的教程,分享小快乐', // 站点描述，被notion中的页面描述覆盖
