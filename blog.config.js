...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'albacub', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '无名的人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://albacub.com', // 网站地址
